...
export const DynamicCard: React.FC<PropsWithChildren> = ({ children }) => {
  ...
  return (
    ...
    >
      <div className="pointer-events-none">
        ...
        <motion.div
          className="absolute inset-0 z-10  bg-gradient-to-br opacity-100 via-slate-400/50 dark:via-zinc-800 transition duration-1000 group-hover:opacity-50 "
          style={style}
        />
        <motion.div
